...
export function VipSection() {
    return (
        <section className="my-20 px-6">
            <div className="max-w-7xl mx-auto bg-gradient-to-r from-muted to-background border border-glass-border rounded-[2rem] p-10 md:p-16 relative overflow-hidden flex flex-col md:flex-row items-center justify-between shadow-2xl transition-colors duration-500">
                {/* Decorative Glow */}
