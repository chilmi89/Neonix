        ...
        >
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 border-b border-white/5 pb-8">
                <div className="flex items-center gap-6">
                    <div className="h-16 w-16 rounded-[2rem] bg-linear-to-br from-primary to-sky-500 flex items-center justify-center text-white shadow-[0_0_30px_-5px_rgba(var(--color-primary),0.5)]">
                        <Key size={32} />
                    </div>
                    <div>
                        ...
                        <p className="text-glass-text/40 text-lg mt-2 font-medium">Pusat Kendali Akses & Keamanan Sistem</p>
                    </div>
                </div>
                ...
                <div className="flex gap-4">
                    <div className="px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col items-center min-w-[120px]">
                        ...
                        <h3 className="text-2xl font-black text-white leading-none">{permissions.length}</h3>
                    </div>
                    <div className="px-6 py-3 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-md flex flex-col items-center min-w-[120px]">
                        <p className="text-[10px] font-black uppercase tracking-widest text-sky-400 mb-1">Status</p>
                ...
                <div className="lg:col-span-4 space-y-4">
                    <GlassCard className="p-8 border-white/10 shadow-[0_20px_50px_-15px_rgba(0,0,0,0.5)] relative overflow-hidden group">
                        ...
                        <div className="flex items-center gap-3 mb-8">
                            ...
                            <h3 className="text-xl font-bold text-white tracking-tight">Kunci Baru</h3>
                        </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="relative">
                                    <input
                                        ...
                                        required
                                    />
                                    <Lock className="absolute right-5 top-1/2 -translate-y-1/2 text-primary/20" size={20} />
                                </div>
                    ...
                    <div className="p-6 bg-linear-to-br from-white/5 to-transparent rounded-[2rem] border border-white/10 flex items-start gap-4 shadow-xl">
                        ...
                        <div>
                            <p className="text-sm font-bold text-white/80 mb-1">Informasi</p>
                    ...
                    <motion.div variants={slideUp}>
                        {loading && permissions.length === 0 ? (
                            <div className="flex flex-col items-center justify-center py-32 bg-white/5 rounded-[2.5rem] border border-white/10 shadow-2xl">
                                ...
                                <p className="text-lg font-bold text-white/40 tracking-tight">Sinkronisasi Registri...</p>
                            </div>
                        ) : (
                    ...
                    <div className="fixed inset-0 z-100 flex items-center justify-center p-6">
                        ...
                        >
                            ...
                            <div className="mb-10 text-center">
                                ...
                                <h2 className="text-3xl font-black text-white mb-2 tracking-tight">Perbarui Kunci</h2>
