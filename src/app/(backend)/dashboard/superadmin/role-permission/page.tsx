                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div className="flex -space-x-2">
                                                    ...
                                                    {(item.permissions?.length || 0) > 3 && (
                                                        <div className="h-6 w-6 rounded-full border border-black bg-muted flex items-center justify-center text-[8px] font-black text-[var(--muted-foreground)]">
                                                            +{(item.permissions?.length || 0) - 3}
                                                        </div>
                                                    )}
                                                </div>
                            ...
                            <div className="p-6 border-b border-glass-border relative">
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-[10px] text-[var(--muted-foreground)] font-bold uppercase tracking-wider mt-1.5">{selectedRole.name}</p>
                                    </div>
                                </div>
                            </div>
